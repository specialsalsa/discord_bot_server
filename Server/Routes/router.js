...
router.get("/messages-by-user-limit", messageController.selectTotalMessagesByUserWithLimit)

router.get('/messages-by-channel', messageController.selectTotalMessagesByChannel);

router.get('/messages-by/channel/:channel_id', messageController.selectTotalMessagesByChannelID);
